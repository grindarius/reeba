  ...
  <nav class="navbar bg-primary">
      ...
      <div class="form-control">
        <div class="input-group">
          <input
            type="text"
            placeholder="Search"
            class="lg:w-96 input input-bordered"
            v-model="searchText"
            @keyup.enter="
              $router.push({ name: 'Search', query: { ...$route.query, ...{ q: searchText } } })
            "
          />
          <button
            class="btn btn-square bg-warning"
            @click="
              $router.push({ name: 'Search', query: { ...$route.query, ...{ q: searchText } } })
            "
          >
    ...
    <div class="navbar-end">
      ...
      <div v-show="isAuthenticated" class="dropdown dropdown-end">
        ...
        <ul
          tabindex="0"
          class="p-2 mt-3 w-52 font-bold shadow menu menu-compact dropdown-content bg-primary text-base-100 rounded-box"
        >
          <li class="block lg:hidden">
            <router-link to="/create"> Create event </router-link>
          </li>
          <li>
            <router-link :to="`/${userData.username}`"> Profile </router-link>
          </li>
          <li>
  ...
  <footer class="p-10 bg-white footer text-neutral-content">
      ...
      <div class="grid grid-flow-col gap-4">
        <a class="block p-0 rounded-full bg-pale-yellow">
          <a
            ...
            href="https://facebook.com/grindarius"
            target="_blank"
            title="Facebook"
        ...
        <a class="block p-0 rounded-full bg-pale-yellow">
          <a
            rel="noopener noreferrer"
            href="https://https://twitter.com/elonmusk"
            target="_blank"
            title="Twitter"
            class="flex items-center p-1"
          >
        ...
        <a class="block p-0 rounded-full bg-pale-yellow">
          <a
            rel="noopener noreferrer"
            href="https://instagram.com/padpongz_"
            target="_blank"
            title="Instagram"
            class="flex items-center p-1"
          >
    ...
    <div>
      ...
      <a
        ...
        href="https://github.com/grindarius/reeba/blob/main/LICENSE"
      ...
      <a
        class="link link-hover"
        href="https://github.com/grindarius/reeba/blob/main/docs/CONTRIBUTING.md"
        rel="noopener noreferrer"
        target="_blank"
        >How to contribute</a
      >
