...
export default async (
  ...
  instance.get<{
    Params: GetUserFollowersListRequestParams
    Querystring: GetUserFollowersListRequestQuerystring
    Reply: GetUserFollowersListReply
  }>(
    "/:username/followers",
    {
      schema,
    ...
    async request => {
      ...
      const followers = await instance.pg.query<{
        username: string
        isAdmin: boolean
        isVerified: boolean
      }>(
