...
export const creatorType = ["Official", "Local"] as const

export const creatorTypeSchema = Type.Union(
  creatorType.map(c => Type.Literal(c))
)
...
export const searchType = ["Events", "Users"] as const
...
export type GetSearchResultRequestQuerystring = Static<
  typeof getSearchResultRequestQuerystringSchema
>
