...
export type AdminGetUserDataOptions = Static<
  typeof adminGetUserDataSortByOptionSchema
>
...
export type AdminGetUserDataRequestQuerystring = Static<
  typeof adminGetUserDataRequestQuerystringSchema
>
...
export type AdminGrantAdminRequestParams = Static<
  typeof adminGrantAdminRequestParamsSchema
>
...
export type AdminRevokeAdminRequestParams = Static<
  typeof adminRevokeAdminRequestParamsSchema
>
...
export type AdminGrantVerificationRequestParams = Static<
  typeof adminGrantVerificationRequestParamsSchema
>

export const adminGrantVerificationReplySchema = Type.Object({
  message: Type.String()
})
export type AdminGrantVerificationReply = Static<
  typeof adminGrantVerificationReplySchema
>

export const adminRevokeVerificationRequestParamsSchema = Type.Object({
  username: Type.String()
})
export type AdminRevokeVerificationRequestParams = Static<
  typeof adminRevokeVerificationRequestParamsSchema
>

export const adminRevokeVerificationReplySchema = Type.Object({
  message: Type.String()
})
export type AdminRevokeVerificationReply = Static<
  typeof adminRevokeVerificationReplySchema
>

export const adminRemoveUserRequestParamsSchema = Type.Object({
  username: Type.String()
})
export type AdminRemoveUserRequestParams = Static<
  typeof adminRemoveUserRequestParamsSchema
>
...
export type AdminGetTransactionDataSortByOption = Static<
  typeof adminGetTransactionDataSortByOptionSchema
>
...
export type AdminGetTransactionDataRequestQuerystring = Static<
  typeof adminGetTransactionDataRequestQuerystringSchema
>
...
export type AdminGetTransactionDataReply = Static<
  typeof adminGetTransactionDataReplySchema
>
...
export type AdminGetEventDataSortByOption = Static<
  typeof adminGetEventDataSortByOptionSchema
>
...
export type AdminGetEventDataRequestQuerystring = Static<
  typeof adminGetEventDataRequestQuerystringSchema
>
...
export type PostManipulateEventRequestParams = Static<
  typeof postManipulateEventRequestParamsSchema
>
...
export type PostManipulateEventRequestBody = Static<
  typeof postManipulateEventRequestBodySchema
>

export const postManipulateEventReplySchema = Type.Object({
  message: Type.String()
})
export type PostManipulateEventReply = Static<
  typeof postManipulateEventReplySchema
>
...
export type AdminGetStatisticsSummaryRequestQuerystring = Static<
  typeof adminGetStatisticsSummaryRequestQuerystringSchema
>
...
export type AdminGetStatisticsSummaryReply = Static<
  typeof adminGetStatisticsSummaryReplySchema
>
...
export type AdminGetMapsDataRequestQuerystring = Static<
  typeof adminGetMapsDataRequestQuerystringSchema
>
...
export type AdminGetSummaryDataGroupByOption = Static<
  typeof adminGetSummaryDataGroupByOptionSchema
>
...
export type AdminGetTransactionSummaryRequestQuerystring = Static<
  typeof adminGetTransactionSummaryRequestQuerystringSchema
>
...
export type AdminGetTransactionSummaryReply = Static<
  typeof adminGetTransactionSummaryReplySchema
>
...
export type AdminGetRegistrationSummaryRequestQuerystring = Static<
  typeof adminGetRegistrationSummaryRequestQuerystringSchema
>
...
export type AdminGetRegistrationSummaryReply = Static<
  typeof adminGetRegistrationSummaryReplySchema
>

export const adminGetTopEventTagsOfAllTimeRequestQuerystringSchema =
  Type.Object({
    top: Type.Number({ default: 10, minimum: 1, maximum: 15 })
  })
export type AdminGetTopEventTagsOfAllTimeRequestQuerystring = Static<
  typeof adminGetTopEventTagsOfAllTimeRequestQuerystringSchema
>
...
export type AdminGetTopEventTagsOfAllTimeReply = Static<
  typeof adminGetTopEventTagsOfAllTimeReplySchema
>
